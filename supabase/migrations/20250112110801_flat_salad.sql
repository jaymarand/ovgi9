/*
  ...
  1. Changes
    ...
    - Includes all store information including active status and ecommerce flags
    - Uses ON CONFLICT to handle potential duplicates

  2. Data
    - 20 stores with their department numbers and names
    - Preserves original created_at and updated_at timestamps
    - Sets appropriate is_active and ecommerce_enabled flags
*/
